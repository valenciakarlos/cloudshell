...
esxis_details = [r for r in rd.Resources if r.ResourceModelName == 'ComputeShell']
...
for i in range(len(esxis_details)):
    addr = esxis_details[i].FullAddress
...
aa = [
    ...
    ('Service', 'vCenter', 'vCenter Cluster1 ESXis', sio_master_ip),
    ('Service', 'vCenter', 'vCenter Cluster2 ESXis', ','.join(versa_ips)),
    ('Service', 'vCenter', 'vCenter Cluster3 ESXis', ','.join(sio_worker_ips)),
    ('Service', 'vCenter', 'VDS1 Hosts', ','.join(all_sio_versa_ips)),
    ...
    ('Service', 'vCenter', 'VDS4 Hosts', ','.join(versa_ips)),
    ...
    ('Service', 'ScaleIO', 'Host for ScaleIO Gateway', sio_master_ip),
